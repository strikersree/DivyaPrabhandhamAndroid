package com.srinivaskannan.divyaprabhandham.ui.favourites
...
/**
 * Favourites (bookmarked pasurams). Reached from a Home entry point, not a
 * tab — the tab bar's old Saved slot is now Collections; retiring the
 * redundant tab-level screen mirrors the iOS decision exactly.
 *
...
fun FavouritesScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(appState.ui(Ui.FAVOURITES)) },
