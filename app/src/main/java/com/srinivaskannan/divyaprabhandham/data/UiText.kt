...
object UiText {
    ...
    private val table: Map<Ui, Pair<String, String>> = mapOf(
        ...
        Ui.FAVOURITES to ("பிடித்தவை" to "Favourites"),
        Ui.COLLECTIONS to ("தொகுப்புகள்" to "Collections"),
        Ui.NEW_COLLECTION to ("புதிய தொகுப்பு" to "New Collection"),
        Ui.COLLECTION_NAME_PLACEHOLDER to ("தொகுப்பின் பெயர்" to "Collection name"),
        Ui.CREATE_COLLECTION to ("உருவாக்கு" to "Create"),
        Ui.DELETE_COLLECTION to ("தொகுப்பை நீக்கு" to "Delete Collection"),
        Ui.RENAME_COLLECTION to ("பெயர் மாற்று" to "Rename"),
        Ui.NO_COLLECTIONS to ("தொகுப்புகள் இல்லை" to "No collections yet"),
        Ui.NO_COLLECTIONS_HINT to ("ஒரு பாசுரத்தையோ நூலையோ நீண்டமையுங்கள்" to "Long-press a pasuram to start one"),
        Ui.ADD_TO_COLLECTION to ("தொகுப்பில் சேர்" to "Add to Collection"),
        Ui.REMOVE_FROM_COLLECTION to ("தொகுப்பிலிருந்து அகற்று" to "Remove from Collection"),
        Ui.ADD_WHOLE_WORK to ("முழு நூலையும் சேர்" to "Add a whole work"),
        Ui.COLLECTION_PASURAM_COUNT to ("பாசுரங்கள்" to "pasurams"),
        Ui.PIN_COLLECTION to ("முகப்பில் பொருத்து" to "Pin to Home"),
        Ui.UNPIN_COLLECTION to ("முகப்பிலிருந்து அகற்று" to "Unpin from Home"),
        ...
        Ui.SCRIPT_FOOTER to (
            "மூல தமிழ், ஆங்கில ஒலிபெயர்ப்பு, அல்லது தெலுங்கு / மலயாள / தேவநாகரி லிபி. தமிழ் அல்லாத தேர்வு செயலியை ஆங்கிலத்தில் காட்டும்." to
            "Original Tamil, English transliteration, or Telugu, Malayalam or Devanagari script. Anything but Tamil shows the app itself in English."
        ),
        ...
        Ui.UPDATE_READY to ("புதிய பதிப்பு தயார்" to "Update ready to install"),
        Ui.UPDATE_RESTART to ("மீள்தொடக்கம்" to "Restart"),
        Ui.CHECK_FOR_UPDATES to ("புதுப்பிப்பைச் சரிபார்" to "Check for updates"),
        ...
        Ui.PILGRIMAGE_TO_FIRST to ("கோயில்கள் முதல் நிலைக்கு" to "temples to Tier 1"),
        ...
        Ui.ONB_WELCOME_BODY to (
            ...
            "Explore the divine hymns of the Alwars, tailored to your personal devotional journey."),
        Ui.ONB_GET_STARTED to ("தொடங்குங்கள்" to "Get started"),
        Ui.ONB_SKIP to ("இப்போது தவிர்" to "Skip now"),
        Ui.ONB_BACK to ("பின்" to "Back"),
        Ui.ONB_NEXT to ("அடுத்து" to "Next"),
        Ui.ONB_DONE to ("முடிந்தது" to "Done"),
        Ui.ONB_FONT_TITLE to ("எழுத்து அளவு" to "Font size"),
        Ui.ONB_FONT_BODY to ("வாசிப்பதற்கு வசதியான அளவைத் தேர்ந்தெடுக்கவும்." to "Choose a size that's comfortable to read."),
        Ui.ONB_SCRIPT_TITLE to ("எழுத்துரு மற்றும் மொழி" to "Script & language"),
        Ui.ONB_SCRIPT_BODY to ("பாசுரங்களும் பட்டியும் எப்படித் தோன்ற வேண்டும்?" to "How should the verses and menus appear?"),
        Ui.ONB_THEME_TITLE to ("தோற்றம்" to "Theme"),
        Ui.ONB_THEME_BODY to ("உங்கள் வாசிப்புத் தோற்றத்தைத் தேர்ந்தெடுக்கவும்." to "Pick the look of your reading space."),
        ...
        Ui.ONB_SETTINGS_NOTE to (
            ...
            "Note: You can update any of these preferences anytime from the app's Settings menu."),
        ...
        Ui.REMOVE_ADS to ("விளம்பரங்களை நீக்கு" to "Remove ads"),
        Ui.UNLOCK_AD_FREE to ("விளம்பரமில்லா பதிப்பைத் திற" to "Unlock ad-free"),
        Ui.UNLOCK_AD_FREE_DETAIL to ("ஒருமுறை கட்டணம். எல்லா விளம்பரங்களும் நிரந்தரமாக நீக்கப்படும்." to "One-time purchase. Removes ads everywhere, for good."),
        Ui.ALREADY_AD_FREE to ("நீங்கள் ஏற்கனவே விளம்பரமில்லா அணுகல் பெற்றுள்ளீர்கள். நன்றி!" to "You already have ad-free access. Thank you!"),
        ...
        Ui.LISTEN_AMAZON_INSTALL to ("Amazon Music நிறுவப்படவில்லை — Play Store-ஐத் திறக்கிறோம்" to "Amazon Music isn't installed — opening its Play Store page"),
        ...
        Ui.ASK_TTS_UNAVAILABLE to ("இந்தச் சாதனத்தில் குரல் வாசிப்பு இல்லை" to "Speech isn't available on this device"),
