...
object UiText {
    ...
    private val table: Map<Ui, Pair<String, String>> = mapOf(
        ...
        Ui.LISTEN_EMBED_BLOCKED to ("இப்பதிவை செயலியில் இயக்க முடியாது" to "This track can't play in-app"),
        Ui.LISTEN_ERROR to ("பாராயணத்தை இயக்க முடியவில்லை" to "Couldn't play the recitation"),
