...
android {
    ...
    kotlinOptions {
        ...
        // Material 3's newer surfaces — the adaptive navigation suite, the
        // time picker, the search bar — sit behind opt-in markers, and which
        // ones are experimental moves between releases. Declaring them here
        // rather than sprinkling @OptIn through the screens means a marker that
        // graduates, or that is named differently in the resolved version,
        // costs a warning instead of a build failure.
        //
        // ExperimentalMaterial3ExpressiveApi is deliberately absent: in 1.4.0
        // that marker is itself `internal`, so opting in is not possible. See
        // ui/theme/Theme.kt.
